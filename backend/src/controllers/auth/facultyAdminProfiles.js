...
router.post("/", requireRole("SUPER_ADMIN"), facultyAdminProfilesController.postProfile);
...
router.patch("/:id", requireRole("SUPER_ADMIN"), facultyAdminProfilesController.patchProfile);

// Delete a faculty admin profile (Super Admin only)
router.delete("/:id", requireRole("SUPER_ADMIN"), facultyAdminProfilesController.deleteProfile);
