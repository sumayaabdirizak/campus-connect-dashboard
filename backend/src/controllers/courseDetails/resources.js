...
router.post('/reorder', auth, requireResourceReorderManage(), asyncHandler(async (req, res) => {
...
router.post('/modules/reorder', auth, requireModuleReorderManage(), asyncHandler(async (req, res) => {
  const items = Array.isArray(req.body?.items) ? req.body.items : [];
  if (items.length === 0) return res.json({ updated: 0 });
  await prisma.$transaction(
    items.map((it) =>
...
router.patch('/modules/:moduleId', auth, requireModuleManage(), asyncHandler(async (req, res) => {
...
router.delete('/modules/:moduleId', auth, requireModuleManage(), asyncHandler(async (req, res) => {
  const id = parseInt(req.params.moduleId, 10);
...
router.patch('/:resourceId', auth, requireResourceManage(), asyncHandler(async (req, res) => {
...
router.delete('/:resourceId', auth, requireResourceManage(), asyncHandler(async (req, res) => {
...
router.post('/:resourceId/progress', auth, requireResourceRead(), asyncHandler(async (req, res) => {
...
router.get('/:resourceId/my-progress', auth, requireResourceRead(), asyncHandler(async (req, res) => {
...
router.get('/:resourceId/analytics', auth, requireResourceManage(), asyncHandler(async (req, res) => {
  const resourceId = parseInt(req.params.resourceId, 10);
...
router.get('/:courseOfferingId/modules', auth, requireCourseOfferingRead(), asyncHandler(async (req, res) => {
  const courseOfferingId = parseInt(req.params.courseOfferingId, 10);
...
router.post('/:courseOfferingId/modules', auth, requireCourseOfferingManage(), asyncHandler(async (req, res) => {
  const courseOfferingId = parseInt(req.params.courseOfferingId, 10);
