...
import facultiesRouter from './academic/faculties.js';
import departmentsRouter from './academic/departments.js';
import programsRouter from './academic/programs.js';
import academicYearRouter from './academic/academicYear.js';
import batchesRouter from './academic/batches.js';
import batchSectionsRouter from './academic/batchSections.js';
import coursesRouter from './academic/courses.js';
import deanRouter from './dean/dean.js';
import adminRouter from './admin/admin.js';
import studentPortalRouter from './portals/studentPortal.js';
import lecturerPortalRouter from './portals/lecturerPortal.js';
import chatRouter from '../controllers/courses/chat.js';
import groupsRouter from './courses/groups.js';
import rosterRouter from './courses/roster.js';
import quizzesRouter from '../controllers/courses/quizzes.js';
import resourcesRouter from '../controllers/courses/resources.js';
import courseOfferingsRouter from './courses/course-offerings.js';
...
import courseAccessRouter from './courses/course-access.js';
import gradebookRouter from '../controllers/courses/gradebook.js';
import courseActivityNotificationsRouter from './courses/course-activity-notifications.js';
import announcementsRouter from './announcements/routes.announcements.js';
import pushRouter from './announcements/routes.push.js';
