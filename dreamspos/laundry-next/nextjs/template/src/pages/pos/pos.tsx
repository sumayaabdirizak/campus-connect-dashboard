...
import ServicesSliderOne from "./sliders/servicesSliderOne"
        ...
        <>
            ...
            <div className="page-wrapper">
                ...
                <div className="content">
                    {/* Page Header */}
                    <Header title="Edit Order" ordersCount={15} showOrdersButton={true} />
                    {/* End Page Header */}
                    {/* Start Content Wrap */}
                                                ...
                                                <div className="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                    <div className="pos-card active">
                                                        ...
                                                        <div className="p-2 position-relative">
                                                            ...
                                                            <QuantityControl defaultValue={1} />
                                                        </div>
                                                    </div>
                                                </div>
                                                {/* Item */}
                                        ...
                                        <div className="details">
                                            <div className="pos-title d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                                                ...
                                                <p className="d-flex align-items-center gap-1 text-dark mb-0">
                                                    Total Items :{" "}
                                                    <span className="badge bg-light rounded-icon">9</span>
                                                </p>
                                            </div>
                                                ...
                                                <div className="accordion-item">
                                                    <h3 className="accordion-header" id="headingEleven">
                                                        ...
                                                        >
                                                            Dry Cleaning{" "}
                                                            <button
                                                                className="text-danger add-btn fw-semibold fs-13 p-0 border-0 text-decoration-underline"
                                                                data-bs-toggle="offcanvas"
                                                                data-bs-target="#filter-offcanvas-2"
                                                            >
                                                                {" "}
                                                                Add Items
                                                            </button>
                                                        ...
                                                        <div className="accordion-body">
                                                            <div className="accordion-content">
                                                                ...
                                                                <div className="card bg-light mb-0">
                                                                    <div className="card-body p-3">
                                                                        <div className="d-flex align-items-center justify-content-between gap-2 flex-xxl-nowrap flex-wrap">
                                                                            <div>
                                                                            ...
                                                                            <button
                                                                                className="btn btn-icon btn-dark fs-14 fw-normal"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#edit_evening_dress"
                                                                            >
                                                                                <i className="icon-pencil-line" />
                                                                            </button>
                                                                        </div>
                                                        ...
                                                        <div className="accordion-body">
                                                            <div className="accordion-content">
                                                                <h6 className="mb-3 d-flex align-items-center justify-content-between gap-1 fs-14 fw-semibold text-body">
                                                                    ...
                                                                    <span className="text-dark">$128</span>{" "}
                                                                </h6>
                                                                <h6 className="mb-3 d-flex align-items-center justify-content-between gap-1 fs-14 fw-semibold text-body">
                                                                    {" "}
                                                                    <span className="d-flex align-items-center">
