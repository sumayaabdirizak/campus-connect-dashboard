...
const ProductsComponent = () => {
    const [rows, setRows] = useState<DataRow[]>(
        () =>
            (ProductsData as TableData[]).map((row, idx) => ({
                ...row,
        ...
        () => [
            {
                ...
                render: (text: string, record: any) => (
                    <div className="d-flex align-items-center">
                        <Link href="#" className="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                            <ImageWithBasePath src={`assets/img/products/${record.image}`} alt="category" className="img-fluid" />
                        </Link>
                ...
                sorter: (a: DataRow, b: DataRow) => a.product.length - b.product.length,
            },
            {
                title: "Services",
                dataIndex: "serivce",
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-3 justify-content-between mb-4">
                        <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div className="dropdown">
                                ...
                                >
                                    <i className="icon-box text-dark me-2" />
                                    All Products
                                </Link>
                                <div className="dropdown-menu dropdown-menu-lg p-3">
                                    <h6 className="fs-14 fw-semibold mb-3">Products</h6>
                            ...
                            <div className="dropdown">
                                <Link
                                    ...
                                    data-bs-auto-close="outside"
                                >
                                    <i className="icon-zap text-dark me-2" />
                                    Category
                                </Link>
                                <div className="dropdown-menu dropdown-menu-lg p-3">
                ...
                <div className="modal-dialog modal-dialog-centered modal-sm">
                    <div className="modal-content">
                        <div className="modal-body text-center p-4">
                            ...
                            <p className="mb-4">
                                {pendingDelete
                                    ? <>Are you sure you want to delete <br /> <span className="fw-semibold text-dark">{pendingDelete.product} ?</span></>
