        ...
        () => [
            {
                ...
                sorter: (a: DataRow, b: DataRow) => a.Categories.length - b.Categories.length,
            },
            {
                title: "Status",
                dataIndex: "Status",
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-3 justify-content-between mb-4">
                        <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div className="dropdown">
                                ...
                                >
                                    <i className="icon-circle-check-big text-dark me-2" />
                                    All Categories
                                </Link>
                                <div className="dropdown-menu dropdown-menu-lg p-3">
                                    <h6 className="fs-14 fw-semibold mb-3">Categories</h6>
                        ...
                        <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <Link href="#" data-bs-toggle="modal" data-bs-target="#add_category" className="btn btn-primary d-inline-flex align-items-center"><i className="icon-plus me-2"></i>New Categories</Link>
                ...
                <div className="modal-dialog modal-dialog-centered modal-sm">
                    <div className="modal-content">
                        <div className="modal-body text-center p-4">
                            ...
                            <p className="mb-4">
                                {pendingDelete
                                    ? <>Are you sure you want to delete <br /> <span className="fw-semibold text-dark">{pendingDelete.Categories} ?</span></>
