...
import { CustomerListData } from "../../core/json/customerListData";
...
const CustomerListComponent = () => {
    const [rows, setRows] = useState<DataRow[]>(
        () =>
            (CustomerListData as TableData[]).map((row, idx) => ({
                ...row,
                        ...
                        <ul className="dropdown-menu p-3">
                            ...
                            <li>
                                <Link
                                    href="#"
                                    className="dropdown-item rounded d-flex align-items-center"
                                     data-bs-toggle="offcanvas" data-bs-target="#edit_customer">
                ...
                <div className="content">
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-3 justify-content-between mb-4">
                        ...
                        <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <Link href="#" className="btn btn-primary d-inline-flex align-items-center" data-bs-toggle="offcanvas" data-bs-target="#add_customer"><i className="icon-plus me-1"></i>New Customer</Link>
                ...
                <div className="modal-dialog modal-dialog-centered modal-sm">
                    <div className="modal-content">
                        <div className="modal-body text-center p-4">
                            ...
                            <p className="mb-4">
                                {pendingDelete
                                    ? <>Are you sure you want to delete <br /> <span className="fw-semibold text-dark">{pendingDelete.Customer} ?</span></>
