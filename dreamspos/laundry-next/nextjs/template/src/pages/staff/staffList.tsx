...
import { StaffListData } from "../../core/json/staffListData";
...
const StaffListComponent = () => {
    const [rows, setRows] = useState<DataRow[]>(
        () =>
            (StaffListData as TableData[]).map((row, idx) => ({
                ...row,
        ...
        () => [
            {
                ...
                render: (text: string, record: any) => (
                    <div className="d-flex align-items-center">
                        <Link href="#" className="avatar avatar-sm avatar-rounded flex-shrink-0 me-2" data-bs-toggle="offcanvas" data-bs-target="#view_details">
                            <ImageWithBasePath src={`assets/img/staffs/${record.image}`} alt="category" className="img-fluid" />
                        </Link>
                ...
                sorter: (a: DataRow, b: DataRow) => a.staff.length - b.staff.length,
            },
            {
                title: "Role",
                dataIndex: "Role",
                render: (text: string) => (
                    <span className="badge badge-white border-gray d-inline-flex align-items-center" >
                        <span 
                            className={
                                `badge-dot me-1 ${text === "Supervisor" ? "bg-danger" :
                                text === "Removal Expert" ? "bg-cyan" :
                                text === "Branch Manager" ? "bg-pink" :
                                text === "Ironing Staff" ? "bg-indigo" :
                                text === "Admin" ? "bg-success" :
                                text === "Attendant" ? "bg-info" :
                                text === "Technician" ? "bg-success" :
                                text === "Operator" ? "bg-orange" :
                                text === "Biller" ? "bg-warning" : "bg-purple"
                            } `}>
                        </span>
                        {text}
                    </span>
                        ...
                        <ul className="dropdown-menu p-3">
                            ...
                            <li>
                                <Link
                                    href="#"
                                    className="dropdown-item rounded d-flex align-items-center"
                                    data-bs-toggle="offcanvas" data-bs-target="#edit_staff">
                ...
                <div className="content">
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-3 justify-content-between mb-4">
                        <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div className="dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-lg p-3">
                                    <h6 className="fs-14 fw-semibold mb-3">Satffs</h6>
                        ...
                        <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <Link href="#" className="btn btn-primary d-inline-flex align-items-center" data-bs-toggle="offcanvas" data-bs-target="#add_staffs"><i className="icon-plus me-1"></i>New Staff</Link>
                        </div>
                    </div>
                ...
                <div className="modal-dialog modal-dialog-centered modal-sm">
                    <div className="modal-content">
                        <div className="modal-body text-center p-4">
                            ...
                            <p className="mb-4">
                                {pendingDelete
                                    ? <>Are you sure you want to delete <br /> <span className="fw-semibold text-dark">{pendingDelete.staff} ?</span></>
