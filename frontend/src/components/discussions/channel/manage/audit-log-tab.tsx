...
import { listChannelAuditLog } from '@/lib/discussions/queries/service';
import type { DiscussionAuditLogEntry } from '@/lib/discussions/queries/types';
...
export function AuditLogTab({ channelId }: { channelId: string }) {
