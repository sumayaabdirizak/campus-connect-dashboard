    ...
    <header className='shrink-0 border-b border-border/60 bg-background/95 px-3 backdrop-blur-sm'>
      <div className='flex items-center gap-1.5 py-1.5'>
        ...
        <div className='flex shrink-0 items-center gap-1.5'>
          <div className='relative w-[9rem] shrink-0 sm:w-[11rem] md:w-[12rem]'>
            <Search
              aria-hidden
          ...
          {canCreate ? (
            ...
            >
              ...
              {draftCount > 0 ? (
                <Badge
                  className='min-h-4 min-w-4 shrink-0 justify-center rounded-full px-1 py-0 text-[9px] font-semibold tabular-nums'
                  variant='default'
                  aria-hidden
                >
