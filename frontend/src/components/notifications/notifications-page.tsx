      ...
      <div className='w-full space-y-4'>
        ...
        <div className='flex flex-wrap items-center gap-2'>
              ...
              <button
                ...
                className={cn(
                  ...
                  filter === key
                    ...
                    : 'border-[#E5E7EB] text-[#667085] hover:bg-[#F8FAFC]'
                )}
              >
                {label}
              </button>
          ...
          <div className='ml-auto flex items-center gap-2'>
            <div className='relative w-44 sm:w-56'>
              <Search className='absolute top-1/2 left-3 size-4 -translate-y-1/2 text-[#98A2B3]' />
              <Input
                value={q}
                onChange={(e) => setQ(e.target.value)}
                placeholder='Search…'
                className='h-9 rounded-xl border-[#E5E7EB] bg-[#F8FAFC] pl-9'
              />
            </div>
            <Button
              variant='outline'
              size='sm'
              className='h-9 gap-1.5 rounded-full border-[#E5E7EB]'
        ...
        <div className='relative overflow-hidden rounded-2xl border border-[#E5E7EB] bg-white shadow-sm'>
          ...
          <div className='flex items-start justify-between px-5 py-4'>
            <div>
              <h2 className='text-base font-bold text-[#101828]'>Notifications</h2>
          ...
          <div className='p-3'>
            {loading ? (
              ...
              <div className='flex flex-col items-center justify-center py-16'>
                ...
                <p className='text-sm text-[#667085]'>Nothing here</p>
              </div>
            ) : (
