...
import { useGradeAttempt } from '@/lib/course-details/queries/quizzes-queries'
import type { GradedAnswerInput, QuizAttempt } from '@/lib/course-details/services/quizzes-types'
