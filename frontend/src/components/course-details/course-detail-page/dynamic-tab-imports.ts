...
export { default as CourseResources } from '../course-resources'
export { default as CourseReviews } from '../course-reviews'
export { default as CourseRoster } from '../course-roster'
