/** Validate uploaded document display names (File.name / originalname). */

export const DOCUMENT_NAME_MAX_LENGTH = 200;

const SAFE_DOCUMENT_NAME = /^[A-Za-z0-9 ._()\-[\]']+$/;

export const QUIZ_PAPER_EXTENSIONS = ['.pdf', '.doc', '.docx'] as const;
...
export function validateDocumentName(
  ...
  opts?: { allowedExtensions?: readonly string[] }
): DocumentNameResult {
