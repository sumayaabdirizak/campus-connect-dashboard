...
import { ClubLinkCard, extractClubInviteToken } from '@/components/clubs/club-link-card';

/** @user / @role tokens and #group-style channel tags */
const MENTION_SPLIT = /(@\w+|#\w+)/g;

/** Turn chat plaintext into GFM-friendly source (line breaks, â€¢ bullets). */
...
export function DiscussionMessageMarkdown({
  ...
  text: string;
  tone: Tone;
  /** Legacy â€œown messageâ€ purple bubble â€” keep markdown readable on accent fill. */
