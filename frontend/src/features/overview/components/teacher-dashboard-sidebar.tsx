...
type AnnouncementItem = { id: string | number; title: string };
            ...
            <ul className='divide-y divide-border'>
              {announcements.slice(0, 4).map((a) => (
                <li key={a.id}>
                  ...
                  >
                    <Badge variant='secondary' className='mt-0.5 shrink-0 px-1.5 py-0 text-[10px] uppercase'>
                      New
                    </Badge>
                    <span className='line-clamp-2 text-sm text-primary hover:underline'>{a.title}</span>
                  </Link>
                </li>
              ))}
            </ul>
